...
CANoe.Open(r"C:\Desktop\LED\Configuration1.cfg")
time.sleep(3)
...
sys_value = sys_namespace.Variables("Sys_BCM")
...
sys_sig_value = CANoe.GetBus("CAN").GetSignal(1, "BCMMessage", "BCM_Signal") # signal value
